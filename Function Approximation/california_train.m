...
for num_neurons_second = 10:10:50
    for num_neurons = 10:10:50
        ...
        name = ['Trainbr5\performance_',num2str(num_neurons_second),'_',num2str(num_hidden_layers),'_',num2str(num_neurons)];
        h=figure;
        plotperform(tr);
        saveas(h,name,'jpg');
        
        %plot and save trainstate
        name = ['Trainbr5\plottrainstate',num2str(num_neurons_second),'_',num2str(num_hidden_layers),'_',num2str(num_neurons)];
        h=figure;
        plottrainstate(tr);
        saveas(h,name,'jpg');
        
        %plot and save regression
        name = ['Trainbr5\plotregression',num2str(num_neurons_second),'_',num2str(num_hidden_layers),'_',num2str(num_neurons)];
        h=figure;
        ...
        name = ['Trainbr5\plothistogram',num2str(num_neurons_second),'_',num2str(num_hidden_layers),'_',num2str(num_neurons)];
        h=figure;
        ploterrhist(errors);
        saveas(h,name,'jpg');
    ...
    name = ['Trainbr5\misclassification_rate',num2str(num_neurons_second)];
    h=figure;
    ...
    name = ['Trainbr5\mseperformance_rate',num2str(num_neurons_second)];
    saveas(h,name,'jpg');
end
