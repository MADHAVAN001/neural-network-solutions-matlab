...
for num_neurons = 10:10:50
    for alpha = 0.01:0.05:75
        ...
        name = ['Trainlm_2_layers\performance_maxfail',num2str(num_neurons),'_',num2str(alpha*100)];
        h=figure;
        plotperform(tr);
        saveas(h,name,'jpg');
        
        %plot and save trainstate
        name = ['Trainlm_2_layers\plottrainstate',num2str(num_neurons),'_',num2str(alpha*100)];
        h=figure;
        plottrainstate(tr);
        saveas(h,name,'jpg');
        
        %plot and save regression
        name = ['Trainlm_2_layers\plotregression',num2str(num_neurons),'_',num2str(alpha*100)];
        h=figure;
        ...
        name = ['Trainlm_2_layers\plothistogram',num2str(num_neurons),'_',num2str(alpha*100)];
        h=figure;
        ploterrhist(errors);
        saveas(h,name,'jpg');
    ...
    name = ['Trainlm_2_layers\misclassification_rate',num2str(num_neurons)];
    h=figure;
    ...
    name = ['Trainlm_2_layers\mseperformance_rate',num2str(num_neurons)];
    saveas(h,name,'jpg');
    %end
