...
for num_neurons = 10:10:50
    ...
    name = ['Trainlm_varyratio\performance_maxfail',num2str(i),'_',num2str(num_neurons_second),'_',num2str(num_hidden_layers),'_',num2str(num_neurons)];
    h=figure;
    plotperform(tr);
    saveas(h,name,'jpg');
    
    %plot and save trainstate
    name = ['Trainlm_varyratio\plottrainstate',num2str(num_neurons_second),'_',num2str(num_hidden_layers),'_',num2str(num_neurons)];
    h=figure;
    plottrainstate(tr);
    saveas(h,name,'jpg');
    
    %plot and save regression
    name = ['Trainlm_varyratio\plotregression',num2str(num_neurons_second),'_',num2str(num_hidden_layers),'_',num2str(num_neurons)];
    h=figure;
    ...
    name = ['Trainlm_varyratio\plothistogram',num2str(num_neurons_second),'_',num2str(num_hidden_layers),'_',num2str(num_neurons)];
    h=figure;
    ploterrhist(errors);
    saveas(h,name,'jpg');
...
name = ['Trainlm_varyratio\misclassification_rate',num2str(num_neurons_second)];
h=figure;
...
name = ['Trainlm_varyratio\mseperformance_rate',num2str(num_neurons_second)];
saveas(h,name,'jpg');
%end

name = ['Trainlm_varyratio\Misclassification_rate'];
save(name);
