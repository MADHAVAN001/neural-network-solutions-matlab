...
for num_neurons = 10:2:57
    ...
    name = ['Train\performance_',num2str(num_hidden_layers),'_',num2str(num_neurons)];
    h=figure;
    plotperform(tr);
    saveas(h,name,'jpg');
    
    %plot and save trainstate
    name = ['Train\plottrainstate',num2str(num_hidden_layers),'_',num2str(num_neurons)];
    h=figure;
    plottrainstate(tr);
    saveas(h,name,'jpg');
    
    %plot and save regression
    name = ['Train\plotregression',num2str(num_hidden_layers),'_',num2str(num_neurons)];
    h=figure;
    ...
    name = ['Train\plothistogram',num2str(num_hidden_layers),'_',num2str(num_neurons)];
    h=figure;
    ploterrhist(errors);
    saveas(h,name,'jpg');
...
name = ['Train\misclassification_rate'];
h=figure;
...
name = ['Train\mseperformance_rate'];
saveas(h,name,'jpg');
