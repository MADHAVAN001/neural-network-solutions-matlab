...
for num_neurons_second = 10:10:10
    ...
    for num_neurons = 10:10:50
        [net] = newff(minmax(P_train),[num_neurons 1],{'tansig','tansig'},'traingd');
        ...
        name = ['Traingd4\performance_',num2str(num_neurons),'_',num2str(num_neurons_second),'_',num2str(alpha*100)];
        h=figure;
        plotperform(tr);
        saveas(h,name,'jpg');
        
        %plot and save trainstate
        name = ['Traingd4\plottrainstate',num2str(num_neurons),'_',num2str(num_neurons_second),'_',num2str(alpha*100)];
        h=figure;
        plottrainstate(tr);
        saveas(h,name,'jpg');
        
        %plot and save regression
        name = ['Traingd4\plotregression',num2str(num_neurons),'_',num2str(num_neurons_second),'_',num2str(alpha*100)];
        h=figure;
        ...
        name = ['Traingd4\plothistogram',num2str(num_neurons),'_',num2str(num_neurons_second),'_',num2str(alpha*100)];
        h=figure;
        ploterrhist(errors);
        saveas(h,name,'jpg');
    ...
    name = ['Traingd4\misclassification_rate',num2str(alpha*100)];
    h=figure;
    ...
    name = ['Traingd4\mseperformance_rate',num2str(alpha*100)];
    saveas(h,name,'jpg');
    name = ['Traingd4\Misclassification_rate',num2str(alpha*100)];
    save(name);
    end
